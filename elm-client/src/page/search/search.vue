...
<div class="paddingTop search_page">
  ...
  <form class="search_form">
    <input type="search" name="search" placeholder="请输入商家或者美食名称" class="search_input" v-model="searchValue" @input="checkInput"/>
...
<script>
  ...
  import {getStore, setStore} from '@/service/mUtils'
...
<style scoped>
  ...
  .list_li .item_right .item_right_detail li {
    font-size: 0;
  }
  .list_li .item_right .item_right_detail li span {
    font-size: 0.5rem;
    vertical-align: middle;
    display: inline-block;
    margin-bottom: 0.2rem;
  }
  .list_li .item_right .item_right_detail li .activities_icon {
    font-size: 0.5rem;
    color: #fff;
    font-weight: bold;
    padding: 0.04rem;
  ...
  .list_li .item_right .item_right_detail li .only_phone {
    color: #FF6000;
  }
